...
// in fluttersampleachitecture/test/features/auth/data/data_sources/auth_remote_data_source_test.dart.
...
import 'package:fluttersampleachitecture/core/network/api_client.dart' as _i3;
    ...
    _i2.Options? options,
      ...
      (super.noSuchMethod(
            Invocation.method(
              #delete,
              [endpoint],
              {#headers: headers, #data: data, #options: options},
            ),
            returnValue: _i5.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
